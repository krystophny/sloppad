...
const CHAT_WS_STALE_THRESHOLD_MS = 2e4;
...
const SOMEDAY_REVIEW_NUDGE_INTERVAL_MS = 7 * 24 * 60 * 60 * 1e3;
const ACTIVE_PROJECT_STORAGE_KEY = "tabura.activeProjectId";
const ACTIVE_SPHERE_STORAGE_KEY = "tabura.activeSphere";
const LAST_VIEW_STORAGE_KEY = "tabura.lastView";
const RUNTIME_RELOAD_CONTEXT_STORAGE_KEY = "tabura.runtimeReloadContext";
const TOOL_PALETTE_POSITION_STORAGE_KEY = "tabura.toolPalettePosition";
const SIDEBAR_IMAGE_EXTENSIONS = /* @__PURE__ */ new Set([".png", ".jpg", ".jpeg", ".gif", ".webp", ".bmp", ".svg", ".ico", ".avif"]);
...
const state = {
  ...
  disclaimerVersion: "",
  welcomeSurface: null,
  pendingByTurn: /* @__PURE__ */ new Map(),
  pendingApprovals: /* @__PURE__ */ new Map(),
  pendingQueue: [],
  assistantActiveTurns: /* @__PURE__ */ new Set(),
...
export {
  ...
  ASSISTANT_ACTIVITY_POLL_MS,
  CHAT_CTRL_LONG_PRESS_MS,
  CHAT_WS_STALE_THRESHOLD_MS,
  COMPANION_IDLE_SURFACES,
  COMPANION_REFERENCES_VIEW_PATH,
  COMPANION_RUNTIME_STATES,
  COMPANION_SUMMARY_VIEW_PATH,
  COMPANION_TRANSCRIPT_VIEW_PATH,
  COMPANION_VIEW_PATH_PREFIX,
  DEV_UI_RELOAD_POLL_MS,
  ITEM_SIDEBAR_DEFAULT_LATER_HOUR_UTC,
  ITEM_SIDEBAR_GESTURE_CANCEL_PX,
  ITEM_SIDEBAR_GESTURE_COMMIT_PX,
  ITEM_SIDEBAR_GESTURE_LONG_PX,
  ITEM_SIDEBAR_MENU_ID,
  ITEM_SIDEBAR_VIEWS,
  LAST_VIEW_STORAGE_KEY,
  MEETING_REFERENCES_LABEL,
  MEETING_SUMMARY_ITEMS_PANEL_ID,
  MEETING_SUMMARY_LABEL,
  MEETING_TRANSCRIPT_LABEL,
  PANEL_MOTION_WATCH_QUERIES,
  PROJECT_CHAT_MODEL_ALIASES,
  PROJECT_CHAT_MODEL_REASONING_EFFORTS,
  RUNTIME_RELOAD_CONTEXT_STORAGE_KEY,
  SIDEBAR_IMAGE_EXTENSIONS,
  SOMEDAY_REVIEW_NUDGE_ENABLED_STORAGE_KEY,
  SOMEDAY_REVIEW_NUDGE_INTERVAL_MS,
  SOMEDAY_REVIEW_NUDGE_LAST_SHOWN_STORAGE_KEY,
  SPHERE_OPTIONS,
  TOOL_PALETTE_MODES,
  TOOL_PALETTE_POSITION_STORAGE_KEY,
  TTS_SILENT_STORAGE_KEY,
  VOICE_LIFECYCLE,
  YOLO_MODE_STORAGE_KEY,
  getState,
  isVoiceTurn,
  refs,
  setAppRefs,
