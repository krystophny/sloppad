...
function availableCommandCenterCommands() {
  ...
  commands.splice(5, 0, {
    ...
    detail: replyItem ? `Reply to ${String(replyItem?.title || replyItem?.artifact_title || "selected email").trim() || "selected email"}.` : "Select an email item in the sidebar to reply.",
    shortcut: "R",
  ...
  commands.splice(6, 0, {
    ...
    detail: replyAllItem ? `Reply all to ${String(replyAllItem?.title || replyAllItem?.artifact_title || "selected email").trim() || "selected email"}.` : "Select an email item in the sidebar to reply all.",
    shortcut: "A",
  ...
  commands.splice(7, 0, {
    ...
    detail: forwardItem ? `Forward ${String(forwardItem?.title || forwardItem?.artifact_title || "selected email").trim() || "selected email"}.` : "Select an email item in the sidebar to forward.",
    shortcut: "F",
...
function handleCommandCenterShortcut(ev, deps) {
...
//# sourceMappingURL=app-command-center.js.map
