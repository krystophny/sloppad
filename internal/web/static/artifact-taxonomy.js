...
const CANONICAL_ACTION_SEMANTICS = Object.freeze([
  "open_show",
  "annotate_capture",
  "compose",
  "bundle_review",
...
const ARTIFACT_KIND_TAXONOMY = Object.freeze({
...
function artifactKindSpec(kind) {
...
function artifactCanvasEventKind(kind, refPath = "") {
  const normalized = normalizeArtifactKind(kind);
...
function artifactSupportsMailActions(kind) {
  return artifactKindSpec(kind).mail_actions === true;
}
function artifactUsesThreadHTML(kind) {
  return normalizeArtifactKind(kind) === "email_thread";
}
export {
  ARTIFACT_KIND_TAXONOMY,
...
//# sourceMappingURL=artifact-taxonomy.js.map
