...
run_local_llm_profile_static_checks() {
    ...
    assert_contains "${ROOT_DIR}/scripts/setup-local-llm.sh" 'TABURA_VLLM_MLX_SOURCE_DIR'
    ...
    assert_contains "${ROOT_DIR}/scripts/install-tabura-user-units.sh" 'sync_macos_vllm_source_checkout'
    ...
    assert_contains "${ROOT_DIR}/deploy/launchd/io.tabura.llm.plist" "TABURA_VLLM_MLX_SOURCE_DIR"
